...
<body>
    ...
    <section class="page-header" class="about-header">
        <h2>#KnowUs</h2>
        <p>Loerm ispum dolor sit emet consectetur</p>
    </section>
    <section id="about-head" class="section-p1">
        ...
        <div>
            <h2>Who We Are</h2>
            <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis auteirure dolor
            ...
            <marquee bgcolorr="#ccc" loop="-1" scrollamount="5" width="100%"> Create stunning images with as much or as little control as you like thanks to choice of Basic and creative modes.
            </marquee>
        </div>

    </section>
    <section id="app-about" class="section-p1">
        <h1>Download Our<a href="https://play.google.com/store/apps/details?id=com.zahomy.app.zahomy&hl=vi-VN">App</a></h1>
        <div class="video">
